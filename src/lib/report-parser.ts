...
function detectRiskLevel(text: string): "high" | "medium" | "low" | undefined {
  const t = text.toLowerCase();
  if (t.includes("🔴") || t.includes("হাই") || t.includes("high")) return "high";
  if (t.includes("🟡") || t.includes("মিডিয়াম") || t.includes("medium")) return "medium";
  if (t.includes("🟢") || t.includes("লো") || t.includes("low")) return "low";
  return undefined;
}
